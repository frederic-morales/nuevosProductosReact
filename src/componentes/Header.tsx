...
function Header() {
  return (
    <div className="bg-white text-[12px] sm:text-base mt-[12px] md:mt-5">
      <div className="w-full">
        ...
        <div className="flex sm:justify-start w-full sm:gap-4">
          ...
          <div className="flex sm:flex-row sm:w-1/4 items-center px-1 sm:ml-2 sm:p-3 sm:gap-2">
            <svg
            ...
            <span className="text-center font-semibold text-[#252C32]">
          ...
          <div className="flex sm:gap-4 w-2/4 justify-end">
            <div className="flex">
              <div className="flex cursor-pointer sm:w-28 h-full items-center justify-center rounded-md border px-1 bg-[#4094F7] text-white hover:bg-blue-500">
                ...
                <span className="font-medium text-[8px] sm:text-base">
                  FSOC
                </span>
              </div>
            </div>
